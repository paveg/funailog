...
description: Rebuild my development env with wsl2 and alacritty, additionally I installed zellij as a terminal multiplexer
...
Actually, my development environment was broken when I was developing web application and updating my PC to Windows 11 for a week, ...and suddenly it said 'Goodbye'.
...
You can install the alacritty which is a modern terminal emulator that comes with sensible defaults, but allows for extensive configurations.
