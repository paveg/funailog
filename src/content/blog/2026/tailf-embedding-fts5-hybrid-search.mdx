...
- [blog.diff](https://diff.blog/) - 技術ブログの更新を追えるサービス（海外向け）

tech-blog-rss-feedは非常に便利ですが、企業ブログが中心。blog.diffは海外向けで、日本の個人ブログには対応していません。僕には一つ欲しい機能がありました。**個人ブログから技術記事だけを吸い出して読みたい**というニーズです。
...
tailfは日本の技術ブログを集約するサービスです。[tech-blog-rss-feed](https://yamadashy.github.io/tech-blog-rss-feed/)や[blog.diff](https://and-and.net/blogdiff/)から着想を得て、個人ブログだけでなく企業テックブログにも対応しています。
