---
title: Next.jsからAstroへブログ移行｜LightHouseフルスコア達成までの技術選定と実装
description: Next.jsからAstro+Cloudflare Pagesにブログを移行した理由と実装記録。技術スタック、パフォーマンス改善、実装機能を詳しく解説します。
category: lifestyle
published: 2024-03-20
lastUpdated: 2025-12-24
isPublished: true
tags: ['blog', 'Astro', 'Cloudflare', 'TailwindCSS', 'mdx', 'パフォーマンス']
---
