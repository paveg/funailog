...
export const ui = {
  ja: {
    ...
    'archive.title': '記事アーカイブ',
    'archive.description': '公開済みの全記事を年別にまとめたアーカイブページ',
    'archive.linkText': '年別アーカイブ',
    'series.prefix': '連載: ',
    'series.description': '連載記事の一覧',
    'series.partsSuffix': '回',
  ...
  en: {
    ...
    'archive.description': 'A year-by-year archive of all published posts',
    'archive.linkText': 'Yearly archive',
    'series.prefix': 'Series: ',
    'series.description': 'Posts in this series',
    'series.partsSuffix': ' parts',
